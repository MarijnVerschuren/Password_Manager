...
class Hash(_object):
    ...
    def add(self, data, numBytes):
        return _py_lib.Hash_add(self, data, numBytes)

    def getHash(self):
        return _py_lib.Hash_getHash(self)
...
class SHA256(Hash):
    ...
    def add(self, data, numBytes):
        return _py_lib.SHA256_add(self, data, numBytes)

    def getHash(self, *args):
        return _py_lib.SHA256_getHash(self, *args)
...
def getpass(prompt, show_asterisk=True):
    return _py_lib.getpass(prompt, show_asterisk)
getpass = _py_lib.getpass

def sha256_test():
    return _py_lib.sha256_test()
sha256_test = _py_lib.sha256_test
